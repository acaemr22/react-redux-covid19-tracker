...
export const fetchData = createAsyncThunk(
  ...
  async (region) => {
    ...
    if (region !== "Globe") {
      res = await axios(
        `https://covid-api.com/api/reports?region_name=${region}`,
        {
          headers: {
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(fetchData.rejected, (state, action) => {
        ...
        state.status = "failed";
        // Most of the time request to https://covid-api.com/api/reports/total not being accepted I couldn't find out why but it will always will bring following data
        state.data = {
          date: "2023-03-09",
